...
<img src="assets/demo.gif" alt="Distressed Property Detection: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">3 signals combined · <b>5 failure paths, every one alerted</b> · 0–100 score · under 5 minutes to alert</p>
...
<img src="assets/output.png" alt="Distressed Property Detection: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
